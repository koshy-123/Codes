...
//			Thread.sleep(2000);
//			WebElement nine = driver.findElement(By.xpath("(//li[@class=\"air__subbar__breadcrumb dashboardicon\"])[1]"));
//			nine.click();
//			
//			
//			Thread.sleep(2000);
//			WebElement document = driver.findElement(By.xpath("(//img[@src=\"./assets/svg/doc.svg\"])"));
//			document.click();
//			
//			
//			Thread.sleep(2000);
//			WebElement nine1 = driver.findElement(By.xpath("(//li[@class=\"air__subbar__breadcrumb dashboardicon\"])[1]"));
//			nine1.click();
//			
//			
//			
//			Thread.sleep(2000);
//			WebElement filter = driver.findElement(By.xpath("(//a[@href=\"javascript: void(0);\"])"));
//			filter.click();
//			
//			
//			Thread.sleep(2000);
//			WebElement  searchdoc= driver.findElement(By.xpath("(//input[@placeholder=\"Start typing to search...\"])"));
//			searchdoc.click();
			
//			
//			Thread.sleep(1000);
//			WebElement checkbox = driver.findElement(By.xpath("(//label[text()=\" Master Document Name \"])"));
//			checkbox.click();	
//			searchdoc.sendKeys(DcSearch);
//			
		

			Thread.sleep(1000);
			WebElement findElement4 = driver.findElement(By.xpath("//*[@id=\"button-alignment\"]"));
			findElement4.sendKeys(DcSearch);
			
			Thread.sleep(2000);
			WebElement findElement5 = driver.findElement(By.xpath("(//a[@class=\"editbtn\"])"));
			findElement5.click();
			
			Thread.sleep(3000);
			WebElement findElement6 = driver.findElement(By.xpath("(//a[@href=\"javascript: void(0);\"])[2]"));
			JavascriptExecutor j = (JavascriptExecutor) driver;
       	 j.executeScript("arguments[0].click();", findElement6);
       	 
       	 
			Actions driv= new Actions(driver);
//			driv.moveToElement(findElement6).doubleClick().perform();
			
			Thread.sleep(3000);                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      
			WebElement findElement7 = driver.findElement(By.xpath("(//img[@src=\"./assets/svg/typetool.svg\"])"));
			driv.moveToElement(findElement7).click().perform();
			
			
			Thread.sleep(3000);
			WebElement findElement8 = driver.findElement(By.xpath("(//tinymce[@placeholder=\"Type here...\"])"));
			JavascriptExecutor js = (JavascriptExecutor) driver;
	       	 js.executeScript("arguments[0].click();", findElement8);
...
Thread.sleep(1000);
			...
			JavascriptExecutor js1 = (JavascriptExecutor) driver;
	       	 js1.executeScript("arguments[0].click();", findElement10);
		 //  driv.moveToElement(findElement10).click().perform();
	       ...
	       WebElement findElement182 = driver.findElement(By.xpath("(//a[@class=\"kit__utils__avatarGroupAdd\"])"));
	           ...
	           js12.executeScript("arguments[0].scrollIntoView();", findElement171);
	        driv.moveToElement(findElement171).click().perform();
