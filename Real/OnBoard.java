...
WebElement findElement42 = driver.findElement(By.xpath("/html/body/app-layout1/div/div/div/app-basemaster/div/div[2]/div/div/div/dx-data-grid/div/div[6]/div/div/div[1]/div/table/tbody/tr[1]/td[10]/div/button"));
findElement42.click();


Thread.sleep(1000);
WebElement findElement451=driver.findElement(By.xpath("/html/body/modal-container/div/div/div[3]/button[1]"));
findElement451.click();
...
//Appointments
//Thread.sleep(2000);
//WebElement findElement12 = driver.findElement(By.xpath("(//a[@href = \"#appointments\"])"));
//Actions set2=new Actions(driver);
//set2.moveToElement(findElement12).click().perform();
//
//WebElement findElement13 = driver.findElement(By.xpath("(//input[@role = \"textbox\"])[6]"));
//   findElement13.sen(//a[@href="#todos"])dKeys(Appoitnments);
//   
//   Thread.sleep(1000);
//   WebElement findElement14 = driver.findElement(By.xpath("(//a[@href=\"javascript:void(0);\"])[14]"));
//   findElement14.click();
//   
