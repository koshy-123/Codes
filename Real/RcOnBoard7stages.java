...
//		
	@Test(dataProvider="Rc")
		public void Config(CharSequence Clientname, CharSequence Hospitallogo, CharSequence Facilitylogo, CharSequence AddressLine1, CharSequence AddressLine2, CharSequence AddressLine3, CharSequence AddressLine4, CharSequence clientzipcode1, CharSequence PhoneNO, CharSequence firstgender, CharSequence fname, CharSequence lname, CharSequence fall12, CharSequence fall22, CharSequence jobtitle, CharSequence phoneno2, CharSequence clientemail, CharSequence clientdesc, CharSequence todo, CharSequence userconfiguration, CharSequence Activity2,CharSequence Bulletin, CharSequence config2) throws InterruptedException, AWTException {// stage 1
Actions fed= new Actions(driver);
...
//	    
	 ...
	 fed.moveToElement(Home).click().perform();
...
//		System.out.println(text);
	...
	Thread.sleep(3000);
	WebElement save1 = driver.findElement(By.xpath("/html/body/modal-container/div/div/div/div[2]/div/form/div/div[1]/div[2]/ul/li[2]/button"));
	save1.click();
	
	Thread.sleep(2000); 
	WebElement findElement = driver.findElement(By.xpath("/html/body/modal-container/div/div/div/div[2]/div/form/div/div/div/div[1]/div/div/div/div/div/div/div/div/label"));
	findElement.click();
	

	
	Thread.sleep(2000);
	WebElement findElement2 = driver.findElement(By.xpath("/html/body/modal-container/div/div/div/div[2]/div/form/div/div/div/div[2]/input"));
	findElement2.click();
...
//	 	     String s112="Selmen Delmen";
	    ...
	    //Activities
	     ...
	     Thread.sleep(2000);
	     WebElement Activities = driver.findElement(By.xpath("(//a[@href=\"#/home/activities\"])"));
	     JavascriptExecutor j = (JavascriptExecutor) driver;
       	 j.executeScript("arguments[0].click();", Activities);
...
//			documenton.click();
		...
		status.click();
			...
			//config
			Thread.sleep(2000);
			WebElement config = driver.findElement(By.xpath("(//a[@href=\"#/home/baseconfig\"])"));
			JavascriptExecutor js43 = (JavascriptExecutor) driver;
			js43.executeScript("window.scrollBy(0,-500)");
			JavascriptExecutor j1 = (JavascriptExecutor) driver;
       	 j1.executeScript("arguments[0].click();", config);
